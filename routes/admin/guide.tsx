  ...
  return(
    <Layout>
        <div class='block w-full overflow-x-auto max-w-md mx-auto whitespace-pre-wrap'>
            ...
            - 주자 부분이 자동입력됩니다.<br/>
            - 릴레이 등록 시 카테고리와 컨셉을 지정할 수 있습니다.(최대 50글자)<br/>
            <br/><br/>
            v.0.1.3(5th Apr 23')<br/><br/>
            - 릴레이 등록시 첫글 내용을 입력할 수 있습니다.<br/>
            <br/><br/>
            v.0.1.2(30th Mar 23')<br/><br/>
            - 릴레이 등록시, 규칙을 추가, 수정할 수 있습니다.<br/>
            - 릴레이 회차가 자동으로 매겨집니다.<br/>
            - 제출시, 본문을 입력하도록 변경했습니다.<br/>
            <br/><br/>
            v.0.1.1(26th Mar 23')<br/><br/>
            - 그림, 음악 등 링크가 있는 주제일 경우, 주제를 클릭하면 링크를 볼 수 있습니다.<br/>
            - 구글독스 링크를 제거했습니다.<br/>
            <br/><br/>
