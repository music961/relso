    ...
    return (
      ...
      <table class="p-4 shadow-md">
          ...
          <tr>
              ...
              <td class="px-4"><input class="bg-black fill-current" id="fellEmail" type="date"/></td>
              <td class="px-4"><input class="bg-black text-red-500 fill-current" id="fellEmail" type="time"/></td>
          </tr>
          <tr>
